...
- Billing reads and monthly utility previews are enforced by Application Services. Student billing reads are scoped to the current student; building managers are scoped to assigned building rooms.
