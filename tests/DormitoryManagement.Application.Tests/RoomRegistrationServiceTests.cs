...
public sealed class RoomRegistrationServiceTests
{
    ...
    [Fact]
    public async Task CreateRegistrationAsync_rejects_duplicate_payment_pending_registration_for_student()
    {
        var fixture = RegistrationFixture.CreateStudent();
        fixture.UnitOfWork.Set<RoomRegistration>().Items.Add(new RoomRegistration
        {
    ...
    [Fact]
    public async Task CreateRegistrationAsync_rejects_unavailable_room_status_before_creating_request()
    {
        var fixture = RegistrationFixture.CreateStudent();
        fixture.Room.Status = RoomStatus.Maintenance;
